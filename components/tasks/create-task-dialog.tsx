...
import { FileText, Calendar, FolderOpen, Plus } from 'lucide-react'
...
export function CreateTaskDialog({ open, onOpenChange }: CreateTaskDialogProps) {
  ...
  const { create_task, isLoading } = useTask()
  const { groups } = useGroup() // ✅ استدعاء المجموعات من provider
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] resize-none transition-all duration-200 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 ${
                    errors.text ? "border-red-300 focus:border-red-500 focus:ring-red-500/20" : ""
                  }`}
                />
                {errors.text && (
